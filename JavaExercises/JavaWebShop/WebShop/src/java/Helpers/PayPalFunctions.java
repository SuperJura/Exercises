...
public class PayPalFunctions {
    ...
    public static String gv_APIEndpoint;
    public static String gv_BNCode;
    public static String gv_Version;
    public static String gv_nvpHeader;
    public static String gv_ProxyServer;
    public static String gv_ProxyServerPort;
    public static int gv_Proxy;
    ...
    public PayPalFunctions() {//lhuynh - Actions to be Done on init of this class
        ...
        gv_APIUserName = "jura1994jk-facilitator_api1.hotmail.com";
        gv_APIPassword = "NV9EPKTNG98WXQQ8";
        gv_APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AmEaVy8nudUk8k0DuDxj6WFwod9q";
